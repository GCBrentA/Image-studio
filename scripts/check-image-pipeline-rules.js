...
assert.match(imageProcessing, /const shouldUseOpenAiPrimaryRender =[\s\S]*!backgroundIsTransparent;/, "transparent flexible jobs do not use OpenAI as the primary renderer");
assert.match(imageProcessing, /transparent-source-locked-first/, "transparent flexible jobs log source-locked local-first routing");
