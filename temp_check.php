...
echo Catalogue_Image_Studio_SaaSClient::build_api_url_for_base('https://www.optivra.app/api', '/api/image-studio/audits/start'), "\n";
echo Catalogue_Image_Studio_SaaSClient::build_api_url_for_base('https://www.optivra.app/api', '/api/api/image-studio/audits/start'), "\n";
echo Catalogue_Image_Studio_SaaSClient::build_api_url_for_base('https://www.optivra.app/api/api', '/api/image-studio/audits/start'), "\n";
